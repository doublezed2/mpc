...
<body class="A4">
  <section class="sheet padding-10mm">
    ...
    $now_date = date('Y-m-d');
    ?>
    <h1>Madani Pharmacies Chain - List of expired medicine </h1> 
    <table>
        <tr>
        ...
        $sql = "SELECT * FROM stock WHERE p_type = 'medicine' AND total_stock > 0 AND p_expiry < '$now_date' ORDER BY p_expiry" ;
