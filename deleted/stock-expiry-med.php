...
<body class="A4">
  <section class="sheet padding-10mm">
    <?php
    $now_date = date('Y-m-d');
    $expiry_date = date('Y-m-d', strtotime("+5 months", strtotime($now_date)));
    ?>
    <h1>Madani Pharmacies Chain - List of medicine expiring before <?php echo $expiry_date; ?></h1> 
    ...
    <table>
        ...
        $sql = "SELECT * FROM stock WHERE p_type = 'medicine' AND total_stock > 0 AND p_expiry > '$now_date' AND p_expiry < '$expiry_date' ORDER BY p_expiry" ;
