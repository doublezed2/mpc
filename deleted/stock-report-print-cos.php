...
<body class="A4">
  <section class="sheet padding-10mm">
    <h1>MPC - General Stock Report - As of <?php echo date("d-M-Y"); ?></h1> 
    <table>
        <tr>
        ...
        $sql = "SELECT * FROM stock WHERE p_type = 'cosmetics' ORDER BY p_name" ;
        ...
        <h2>Total Stock TP: <?php echo $gt_nd_tp; ?></h2>
  </section>
  </body>
</html>