...
<body class="A4">
  <section class="sheet padding-10mm">
    <h1>Madani Pharmacies Chain - Cosmetics Stock Report - As of <?php echo date("d-M-Y"); ?></h1>
    <h2>RT Value: 830,910</h2>
    <h2>TP Value: 684,268</h2>
    <table>
        <tr>
        ...
        $sql = "SELECT * FROM stock WHERE total_stock > 0 AND p_type = 'cosmetics' ORDER BY p_name" ;
