            ...
            <table class="table table-bordered table-striped table-sm">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><input type="text" class="form-control form-control-sm" placeholder="Batch" name="p-batch-<?php echo $i; ?>" value="" ></td>
                  <td><input type="number" class="form-control form-control-sm w-60px pck" placeholder="Pck" name="p-pck-<?php echo $i; ?>"></td>
                  ...
                  <td><input type="text" class="form-control form-control-sm up" placeholder="Unit Price" name="p-up-<?php echo $i; ?>"></td>
                </tr>
                <?php
                  endfor;
                ?>
