...
<head>
  <meta charset="utf-8">
  <title>Short Stock Cosmetics</title>
...
<body class="A4">
  <section class="sheet padding-10mm">
    <h1>Madani Pharmacies Chain - Low stock in Cosmetics</h1> 
    <table>
        <tr>
        ...
        $sql = "SELECT id, p_name, company, p_batch, p_expiry, SUM(total_stock) AS available_stock FROM stock WHERE p_type='cosmetics' GROUP BY p_name HAVING available_stock BETWEEN 1 AND 15 ORDER BY `available_stock` ASC" ;
