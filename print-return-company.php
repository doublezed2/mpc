...
<head>
  <meta charset="utf-8">
  <title>Print Return Report</title>
...
<body class="A4">
  ...
  <section class="sheet padding-10mm">
    <h1>MPC - Stock Return Report - Invoice: <?php echo $inv; ?> </h1> 
    <table>
        <tr>
            <th class="small">S.No.</th>
            <th class="xlarge">Name</th>
            <th class="med">Company</th>
        ...
        $sql = "SELECT * FROM return_company WHERE return_invoice = '$inv' ORDER BY p_name" ;
        ...
        if ($result->num_rows > 0) {
          ...
          <tr>
            ...
            <td class="med"><?php echo $row['company']; ?></td>           
