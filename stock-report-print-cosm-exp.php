...
<body class="A4">
  <section class="sheet padding-10mm">
    ...
    ?>
    <h1>MPC - General Expiry Report - before <?php echo $expiry_date; ?></h1> 
    <table>
        <tr>
        ...
        $sql = "SELECT * FROM stock WHERE p_type = 'cosmetics' AND total_stock > 0 AND p_expiry >= '$now_date' AND p_expiry <= '$expiry_date' ORDER BY p_expiry" ;
