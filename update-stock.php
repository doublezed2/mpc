          ...
          <form class="needs-validation" method="POST" action="update-stock-process.php">
            ...
            <div class="row">
              ...
              <div class="col-md-2 mb-3">
                ...
                <select class="custom-select d-block w-100" name="p_type" id="p-type">
                  <?php
                    $m_selected = "";
                    $c_selected = "";
                  ...
                  <option value="cosmetics" <?php echo $c_selected; ?>>Cosmetics</option>
                </select>
              </div>
              <div class="col-md-2 mb-3">
            ...
            <div class="row">
              ...
              <div class="col-md-1 mb-2">
                ...
                <input type="text" class="form-control" name="packing" id="packing" value="<?php echo $s_row['packing'] ?>">
              </div>
              ...
              <div class="col-md-2 mb-2 w10p">
                ...
                <input type="text" class="form-control" name="r_price" id="rp" value="<?php echo $s_row['r_price'] ?>">
              </div>
              <div class="col-md-2 mb-2 w10p">
                <label for="cc-name">TP</label>
                <input type="text" class="form-control" name="t_price" id="tp" value="<?php echo $s_row['t_price'] ?>">
              </div>
              <div class="col-md-2 mb-2 w10p">
                <label for="cc-name">Unit Price</label>
                <input type="text" class="form-control" name="u_price" id="up" value="<?php echo $s_row['u_price'] ?>">
              </div>
              <div class="col-md-2 mb-2 w10p">
