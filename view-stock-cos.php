  ...
  <body>
    <div class="container-fluid">
      ...
      <?php include("sidebar.php") ?>
        ...
        <div class="col-md-12">
        <?php
          $rt_sql = "SELECT SUM(u_price*total_stock) AS total_stock_value_rt, SUM((t_price/packing)*total_stock) AS total_stock_value_tp FROM stock WHERE p_type='cosmetics' AND total_stock > 0 ";
        ...
        <div class="col-md-12 order-md-1">
           <h4 class="mb-3">Current Cosmetics Stock</h4>
            <table style="font-size:14px" class="table table-bordered table-striped table-sm">
              ...
              $sql = "SELECT * FROM stock WHERE p_type='cosmetics' AND total_stock > 0 ORDER BY p_name";
